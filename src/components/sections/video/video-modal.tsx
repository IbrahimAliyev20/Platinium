...
export default function VideoModal({
  ...
  }, [currentIndex, navigateToNext, navigateToPrevious, onClose]);
        ...
        >
          <div className="relative w-full h-full">
            <iframe
              ...
              className="w-full h-full max-h-[80vh] max-w-full bg-black"
              frameBorder="0"
          ...
          <div className="absolute top-0 left-0 right-0 bg-black/70 p-4 text-white">
